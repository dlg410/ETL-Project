...
ALTER TABLE "World Happines Report" ADD CONSTRAINT "fk_World Happines Report_GDP per Capita_Life Ladder_Life Expectancy at Birth" FOREIGN KEY("GDP per Capita", "Life Ladder", "Life Expectancy at Birth")
REFERENCES "Human Development Index HDI" ("GNI Index", "Education Index", "Life Expectancy Index");

ALTER TABLE "Education Index" ADD CONSTRAINT "fk_Education Index_Expected Years of Schooling" FOREIGN KEY("Expected Years of Schooling")
REFERENCES "Human Development Index HDI" ("Education Index");

ALTER TABLE "Education Index" ADD CONSTRAINT "fk_Education Index_Mean Years of Schooling" FOREIGN KEY("Mean Years of Schooling")
REFERENCES "Human Development Index HDI" ("Education Index");

ALTER TABLE "Life Expectancy Index" ADD CONSTRAINT "fk_Life Expectancy Index_Life expectancy at Birth" FOREIGN KEY("Life expectancy at Birth")
REFERENCES "Human Development Index HDI" ("Life Expectancy Index");

ALTER TABLE "Gross National Income" ADD CONSTRAINT "fk_Gross National Income_GNI per Capita" FOREIGN KEY("GNI per Capita")
REFERENCES "Human Development Index HDI" ("GNI Index");

ALTER TABLE "Inequality-Adjusted HDI" ADD CONSTRAINT "fk_Inequality-Adjusted HDI_Inequality-Adjusted Education Index_Inequality-Adjusted Income Index_Inequality-Adjusted Life Expectancy Index" FOREIGN KEY("Inequality-Adjusted Education Index", "Inequality-Adjusted Income Index", "Inequality-Adjusted Life Expectancy Index")
REFERENCES "Human Development Index HDI" ("Education Index", "GNI Index", "Life Expectancy Index");

ALTER TABLE "Inequality-Adjusted HDI" ADD CONSTRAINT "fk_Inequality-Adjusted HDI_Inequality in Education_Inequality in Income_Inequality in Life Expectancy" FOREIGN KEY("Inequality in Education", "Inequality in Income", "Inequality in Life Expectancy")
REFERENCES "Human Development Index HDI" ("Education Index", "GNI Index", "Life Expectancy Index");
